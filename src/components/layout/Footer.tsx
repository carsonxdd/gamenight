    ...
    <footer className="border-t border-border bg-surface/50 py-10">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-4">
        ...
        <div className="flex items-center gap-4">
          <a
            href="https://github.com/carsonxdd/gamenight"
            target="_blank"
            rel="noopener noreferrer"
            className="text-foreground/30 transition hover:text-foreground/60"
            aria-label="GitHub"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-foreground/30 transition hover:text-foreground/60 text-sm"
          >
            carsoncaplan.com
          </a>
        </div>
