      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="mt-2 flex items-start gap-2.5 rounded-lg border border-border bg-surface-lighter p-4 text-left">
          ...
          <p className="text-xs text-foreground/50 leading-relaxed">
            We only receive your Discord <span className="text-foreground/70">username</span> and <span className="text-foreground/70">profile picture</span>. We cannot see your password, email, DMs, friends list, or servers.
          </p>
        </div>
      </div>
    );
